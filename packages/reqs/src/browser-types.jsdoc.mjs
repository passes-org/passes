 ...
 * @property {'org.passes.messaging.connect'} type - The type of the result, should be 'org.passes.messaging.connect'.
 */

/**
 * Sends a request from the Requesting App to the Pass Provider.
 * @typedef {Object} RequestMessage
 * @property {'org.passes.messaging.request'} type - The type of the result, should be 'org.passes.messaging.result'.
 ...
 * @property {'org.passes.messaging.result'} type - The type of the result, should be 'org.passes.messaging.result'.
